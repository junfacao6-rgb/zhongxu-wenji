...
2026-07-09 frontstage simplification: the public user-facing surface should present only three primary functions: `阅读古籍`, `奇门模块`, and `大六壬金口诀`. Keep courses, terms, member center, admin/import, draft review, and other internal capabilities out of the main public navigation and homepage unless explicitly requested.
