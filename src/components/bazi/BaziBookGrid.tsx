...
interface BaziBookGridProps {
  books: Book[];
}

export default function BaziBookGrid({ books }: BaziBookGridProps) {
  return (
    <div className="bazi-book-grid">
      {books.map((book) => {
        ...
        return (
          <article key={book.id}>
            <BookCover title={book.title} tone="cinnabar" className="bazi-book-cover" />
            <div>
